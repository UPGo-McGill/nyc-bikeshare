### REPORT 2 VECTOR MAPS FOR PRODUCTION ########################################

# These scripts produce the PDF versions of the figures used in the report,
...
network_template <- function(nbhd_value, x_values = 0, y_values = 0, 
  ...
  raster_layer <- 
    ...
    # Parks
    geom_sf(data = osm_networks[[nbhd_value]][[1]], fill = "#BDD490", lwd = 0) +
    # Roads
    ...
    theme(axis.ticks = element_blank(),
          ...
          rect = element_blank(),
          text = element_text(family = "Futura-Medium", colour = "transparent"),
          title = element_text(family = "Futura-CondensedExtraBold", size = 15,
                               colour = "transparent"),
          strip.text = element_text(family = "Futura-Bold", size = 12,
                                    colour = "transparent"),
          legend.title = element_text(family = "Futura-CondensedExtraBold", 
                                      size = 15, colour = "transparent"),
  ...
  vector_layer <- 
    ...
    geom_text_repel(data = filter(osm_networks[[nbhd_value]][[3]], 
    ...
    theme(panel.grid.major = element_line(colour = "transparent"),
          ...
          title = element_text(family = "Futura Condensed", face = "bold",
                               size = 15),
          strip.text = element_text(family = "Futura", face = "bold",
                                    size = 12),
          legend.title = element_text(family = "Futura Condensed", 
  ...
  cowplot::ggdraw() +
    ...
    cowplot::draw_plot(vector_layer)
...
figure_2[[03]] <- 
  network_template(nbhd_value = 9, 
                   x_values = c(0, -500, -450, 0, -250, 0, -350, -350, 0, 700,
                                650, 450, 950, 0, 0, -350, 350, 350, 0), 
                   y_values = c(200, 200, 200, -200, -200, 250, 0, 0, 100, 0, 0,
...
figure_2[[10]] <- 
  network_template(nbhd_value = 5,
                   x_values = c(rep(0, 4), 300, 300, rep(0, 5), 1000, 0, 0,
                                -300, rep(0, 3)),
...
figure_2[[17]] <- 
  network_template(nbhd_value = 12,
                   x_values = c(0, 1500, rep(0, 4), 300, 0, 2400, 0, -500),
